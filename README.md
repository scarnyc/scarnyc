...
1. [deep-agent-one](https://github.com/scarnyc/deep-agent-one): a security-hardened Openclaw runtime on Cloudflare Workers — defense-in-depth implementation. 
2. [moltworkers-poc](https://github.com/scarnyc/moltworker-poc): a general-purpose deep agent that reduces AI tool costs through intelligent reasoning optimization.
